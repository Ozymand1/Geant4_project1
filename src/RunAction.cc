...
void RunAction::BeginOfRunAction(const G4Run *aRun) {
    ...
    int hist010Id = analysisManager->CreateH1("h1","momentum", 300 * 1.4, 0, 6.6);
    int hist1020Id = analysisManager->CreateH1("h2","momentum", 300 * 1.4, 0, 6.6);
    int hist2030Id = analysisManager->CreateH1("h3","momentum", 300 * 1.4, 0, 6.6);
    int hist3040Id = analysisManager->CreateH1("h4","momentum", 300 * 1.4, 0, 6.6);
    int hist4050Id = analysisManager->CreateH1("h5","momentum", 300 * 1.4, 0, 6.6);
    ...
    tupleId->histId[5] = hist6070Id;
    tupleId->histId[6] = hist7080Id;
    tupleId->histId[7] = hist8090Id;
    tupleId->histId[8] = hist90100Id;
    tupleId->histId[9] = hist100110Id;
    tupleId->histId[10] = hist110120Id;
    tupleId->histId[11] = hist120130Id;
    tupleId->histId[12] = hist130140Id;


    int hist010Id1 = analysisManager->CreateH1("h1m","momentum", 300 * 1.4, 0, 6.6);
    int hist1020Id1 = analysisManager->CreateH1("h2m","momentum", 300 * 1.4, 0, 6.6);
    int hist2030Id1 = analysisManager->CreateH1("h3m","momentum", 300 * 1.4, 0, 6.6);
    int hist3040Id1 = analysisManager->CreateH1("h4m","momentum", 300 * 1.4, 0, 6.6);
    int hist4050Id1 = analysisManager->CreateH1("h5m","momentum", 300 * 1.4, 0, 6.6);
    ...
    tupleId->histId1[5] = hist6070Id1;
    tupleId->histId1[6] = hist7080Id1;
    tupleId->histId1[7] = hist8090Id1;
    tupleId->histId1[8] = hist90100Id1;
    tupleId->histId1[9] = hist100110Id1;
    tupleId->histId1[10] = hist110120Id1;
    tupleId->histId1[11] = hist120130Id1;
    tupleId->histId1[12] = hist130140Id1;
